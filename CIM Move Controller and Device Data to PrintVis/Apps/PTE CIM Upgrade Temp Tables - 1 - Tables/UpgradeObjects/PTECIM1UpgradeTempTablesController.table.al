Table 80264 "PTE CIM 1 Upg. TT. Controller"
{
    Caption = 'Controller';
    fields
    {
        ...
        field(16; "Submission Method"; enum "PTE CIM 1 Upg. TT CIM Submission Method")
        {
            DataClassification = CustomerContent;
        ...
        field(50; "CIM System"; Enum "PTE CIM 1 Upg. TT CIM System")
        {
            DataClassification = CustomerContent;
            Caption = 'System';
        }
