Tableextension 80119 "PTE UBG SOint Purchase Header" extends "Purchase Header" //"PVS tableextension6010103"
{
    fields
    {
        field(80117; "PTE UBG  Cont Amount Incl. VAT"; Decimal)
        {
        ...
        field(80118; "PTE UBG  Status"; Option)
        {
            DataClassification = CustomerContent;
            Caption = 'Status';
            Description = 'PRINTVIS';
        ...
        field(80119; "PTE UBG  P-Order Type"; Code[20])
        {
            DataClassification = CustomerContent;
            Caption = 'Order Type';
            Description = 'PRINTVIS';
        ...
        field(80125; "PTE UBG  Expected Receipt Time"; Time)
        {
            DataClassification = CustomerContent;
