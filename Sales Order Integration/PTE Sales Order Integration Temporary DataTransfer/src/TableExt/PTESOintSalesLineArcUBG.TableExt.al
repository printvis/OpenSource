Tableextension 80120 "PTE SOint Sales Line Arc UBG" extends "Sales Line Archive" //"PVS tableextension6010129"
{

    fields
    {
        field(80119; "PTE UPG Qty. Order"; Decimal)
        {
            DataClassification = CustomerContent;
            Caption = 'Prod. Quantity';
            Description = 'PRINTVIS';
        }
        field(80120; "PTE UPG Unit"; Option)
        {
            DataClassification = CustomerContent;
            Caption = 'Unit';
            Description = 'PRINTVIS';
