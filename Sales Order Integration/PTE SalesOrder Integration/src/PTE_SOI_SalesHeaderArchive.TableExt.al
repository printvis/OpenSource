TableExtension 80105 "PTE SOI S. Header Archive" extends "Sales Header Archive" //"PVS tableextension6010128"
{
    fields
    {
        ...
        field(80108; "PTE SOI Reception"; Option)
        {
            DataClassification = CustomerContent;
            Caption = 'Reception';
            Description = 'PRINTVIS';
        ...
        field(80110; "PTE SOI Customer Group Code"; Code[20])
        {
            DataClassification = CustomerContent;
        ...
        field(80111; "PTE SOI Rejection Code"; Code[20])
        {
            DataClassification = CustomerContent;
        ...
        field(80112; "PTE SOI End User Contact"; Code[20])
        {
            DataClassification = CustomerContent;
        ...
        field(80113; "PTE SOI Rejection Text"; Text[100])
        {
        ...
        field(80114; "PTE SOI Comment Case Mgt."; Boolean)
        {
        ...
        field(80115; "PTE SOI Pri. Fin. Item Des."; Text[100])
        {
        ...
        field(80116; "PTE SOI End User Contact Name"; Text[100])
        {
        ...
        field(80117; "PTE SOI Coordinator Name"; Text[80])
        {
        ...
        field(80118; "PTE SOI Order Type Description"; Text[100])
        {
        ...
        field(80119; "PTE SOI Status Text"; Text[250])
        {
        ...
        field(80120; "PTE SOI Person Respon. Name"; Text[50])
        {
