PageExtension 80118 "PTE SOI Sales Credit Memos" extends "Sales Credit Memos" //"PVS pageextension6010191"
{
    layout
    {
        addafter("Job Queue Status")
        {
            ...
            field("PVS PVSStatusCode"; Rec."PTE SOI Status Code")
            {
                ApplicationArea = All;
            ...
            field("PVS PVSOrderPlanner"; Rec."PTE SOI Coordinator")
            {
                ApplicationArea = All;
                AssistEdit = false;
                DrillDown = false;
