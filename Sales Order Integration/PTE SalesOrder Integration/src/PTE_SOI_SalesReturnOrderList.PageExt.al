PageExtension 80129 "PTE SOI S. Return O. List" extends "Sales Return Order List" //"PVS pageextension6010192"
{
    layout
    {
    ...
    actions
    {
        addlast(processing)
        {
            group("PTE SOI PrintVis")
            {
                ...
                action("PTE SOI APPROVE_PURCHASE")
                {
                    ApplicationArea = All;
                ...
                action("PTE SOI SalesOrderList")
                {
                    ApplicationArea = All;
                    Caption = 'Sales Order List';
                    Ellipsis = true;
                    Image = "Report";
                    ToolTip = 'Sales Order List';
