PageExtension 80122 "PTE SOI S.O. List" extends "Sales Order List" //"PVS pageextension6010193"
{
    layout
    {
        addafter("Posting Description")
        {
            field("PVS PVSProductionOrder"; Rec."PTE SOI Production Order")
            {
                ApplicationArea = All;
                Editable = false;
            }
    ...
    var
        PTE_PVS_SOMgt: Codeunit "PVS Salesorder Management";
