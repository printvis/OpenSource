PageExtension 80114 "PTE SOI Purchase Order List" extends "Purchase Order List" //"PVS pageextension6010195"
{
    layout
    {
            ...
            group(PTE_PVSPrintVis)
            {
                ...
                action("PTE SOICaseCard")
                {
                    ...
                    begin
                        ...
                        if CaseRec.ID = 0 then begin
                            CaseRec.SetCurrentkey("Order No.");
                            CaseRec.SetRange("Order No.", Rec."No.");
                            if CaseRec.FindFirst() then;
                        end;
    ...
    var
        PTE_PVS_CacheMgt: Codeunit "PVS Cache Management";
    ...
    */
    ...
    begin
        SOIntProdOrderMgt.READ_Tmp_Saleslines(SaleslineRec_Temp, Rec."Document Type", Rec."No.");
    ...
    procedure "PTE SOI_Get_User_Setup"()
    var
    ...
    begin
        ...
        if PTE_PVS_UserSetupRec."PTE SOI Man P. List Filter" then
            exit;
